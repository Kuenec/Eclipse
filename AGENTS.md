...
- **2026-06-14 — 🔑 SHADER-PACK REJECT: APK-SIGNATURE/TAMPERING ANGLE — INVESTIGATED, LIKELY RED HERRING (could not confirm first-party). ⇐ START HERE NEXT SESSION.** Only one untried test remains (device-pulled production-signed splits, below); expect negative → the gated RBXS-container check is still the true boundary.
