...
const TRANSPARENT_CURSOR_PNG: &[u8] = &[
    ...
    0x8b, 0x00, 0x00, 0x00, 0x0d, 0x49, 0x44, 0x41, 0x54, 0x78, 0xda, 0x63, 0x60, 0x18, 0x05, 0x20,
    0x00, 0x00, 0x01, 0x08, 0x00, 0x01, 0x5d, 0xb7, 0x19, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45,
...
mod tests {
    ...
    #[test]
    fn transparent_cursor_is_an_eight_pixel_rgba_png() {
        ...
        assert_eq!(TRANSPARENT_CURSOR_PNG[25], 6, "RGBA color type");
    }
